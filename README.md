...
__SiteConnectionError__: if _checksite_  _==_  _True_ and the script cannot connect to the url;

__HtmlParsingError__: if _checksite_  _==_  _True_ and the script cannot parse the result page;
